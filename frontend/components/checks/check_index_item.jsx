...
export const CheckIndexItem = ({checkId, tableId, path, status, close, dateCreated}) => {
  ...
  if (checkId === path.split('/')[4]){
    ...
    return (
      <Link to={`/tables/${tableId}/checks/${checkId}`}><div id={status} className='check-index-item'>
